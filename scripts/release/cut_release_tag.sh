...
if [[ "$PUSH_TAG" == "true" ]]; then
  ...
  echo "This will auto-trigger the Release Stable workflow (builds, GitHub release, and Docker)."
  echo "External package dry-runs, website redeploys, and announcements require explicit DX release variables."
fi
