...
bump "marketplace/dokploy/blueprints/zeroclaw/docker-compose.yml" \
  'ghcr\.io/(zeroclaw-labs/zeroclaw|millercarla211-ctrl/dx-agents):[0-9]+\.[0-9]+\.[0-9]+([.-][0-9A-Za-z.-]*)?' \
  "ghcr.io/millercarla211-ctrl/dx-agents:${VERSION}"
bump "marketplace/dokploy/blueprints/dx-agents/docker-compose.yml" \
  'ghcr\.io/(zeroclaw-labs/zeroclaw|millercarla211-ctrl/dx-agents):[0-9]+\.[0-9]+\.[0-9]+([.-][0-9A-Za-z.-]*)?' \
  "ghcr.io/millercarla211-ctrl/dx-agents:${VERSION}"
...
#   - container image tags    `ghcr.io/millercarla211-ctrl/dx-agents:vX.Y.Z`
...
for f in "${docs_files[@]}"; do
  ...
  bump "$rel" \
    'ghcr\.io/(zeroclaw-labs/zeroclaw|millercarla211-ctrl/dx-agents):v?[0-9]+\.[0-9]+\.[0-9]+([.-][0-9A-Za-z.-]*)?' \
    "ghcr.io/millercarla211-ctrl/dx-agents:v${VERSION}"
