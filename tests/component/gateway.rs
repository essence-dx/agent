...
//! verification) in isolation. The gateway module (`dx_agents::gateway`) exposes
...
use dx_agents::gateway::verify_whatsapp_signature;
...
fn gateway_body_limit_is_reasonable() {
    assert_eq!(
        dx_agents::gateway::MAX_BODY_SIZE,
        65_536,
...
fn gateway_timeout_is_reasonable() {
    assert_eq!(
        dx_agents::gateway::REQUEST_TIMEOUT_SECS,
        30,
...
fn gateway_rate_limit_window_is_60s() {
    assert_eq!(
        dx_agents::gateway::RATE_LIMIT_WINDOW_SECS,
        60,
