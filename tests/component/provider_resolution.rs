...
use dx_agents::providers::compatible::{AuthStyle, OpenAiCompatibleModelProvider};
use dx_agents::providers::{
...
fn factory_resolves_openai_codex_provider() {
    let options = dx_agents::providers::ModelProviderRuntimeOptions::default();
