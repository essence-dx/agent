...
use dx_agents::providers::create_model_provider_with_url;
use dx_agents::providers::traits::ModelProvider;
...
fn gemini_convert_tools_returns_prompt_guided() {
    use dx_agents::providers::traits::ToolsPayload;
    use dx_agents::tools::ToolSpec;
