...
use dx_agents::providers::compatible::AuthStyle;
use dx_agents::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use dx_agents::providers::compatible::OpenAiCompatibleModelProvider;
