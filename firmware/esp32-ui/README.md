# DX Agent ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for DX Agent edge scenarios on ESP32.
...
3. Connect UI state with DX Agent edge/runtime messaging
...
- [DX Agent Hardware Design](../../docs/hardware/hardware-peripherals-design.md)
