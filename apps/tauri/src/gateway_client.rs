//! HTTP client for communicating with the DX Agents gateway.
...
mod tests {
    ...
    fn client_custom_url() {
        let client = GatewayClient::new("https://dx-agents.example.com:9999", None);
        assert_eq!(client.base_url, "https://dx-agents.example.com:9999");
    }
