...
use dx_agent_config::schema::FirecrawlConfig;
...
impl WebFetchTool {
    ...
    fn truncate_response(&self, text: &str) -> String {
        ...
        // crates/dx-agent-tools/src/http_request.rs:151). Without this
...
impl Tool for WebFetchTool {
    ...
    async fn execute(&self, args: serde_json::Value) -> anyhow::Result<ToolResult> {
        ...
        // registration time (see dx-agent-runtime::tools::mod).
        ...
        let builder = reqwest::Client::builder()
            ...
            .user_agent("DX Agent/0.1 (web_fetch)");
        let builder =
            dx_agent_config::schema::apply_runtime_proxy_to_builder(builder, "tool.web_fetch");
...
mod tests {
    ...
    fn firecrawl_config_defaults() {
        ...
        assert_eq!(cfg.mode, dx_agent_config::schema::FirecrawlMode::Scrape);
    }
    ...
    fn firecrawl_config_deserializes_from_toml() {
        ...
        assert_eq!(cfg.mode, dx_agent_config::schema::FirecrawlMode::Crawl);
    }
    ...
    fn web_fetch_config_with_firecrawl_section() {
        use dx_agent_config::schema::WebFetchConfig;
        let toml_str = r#"
            enabled = true
            [firecrawl]
            enabled = true
