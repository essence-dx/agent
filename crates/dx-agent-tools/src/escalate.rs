...
impl Tool for EscalateToHumanTool {
    ...
    async fn execute(&self, args: serde_json::Value) -> anyhow::Result<ToolResult> {
        ...
        if wait_for_response {
            ...
            let listen_handle =
                dx_agent_spawn::spawn!(async move { listen_channel.listen(tx).await });
...
mod tests {
    ...
    impl ::dx_agent_api::attribution::Attributable for SilentChannel {
    ...
    impl ::dx_agent_api::attribution::Attributable for RespondingChannel {
        fn role(&self) -> ::dx_agent_api::attribution::Role {
            ::dx_agent_api::attribution::Role::Channel(
                ::dx_agent_api::attribution::ChannelKind::Webhook,
            )
    ...
    impl ::dx_agent_api::attribution::Attributable for StructuredOnlyChannel {
        fn role(&self) -> ::dx_agent_api::attribution::Role {
            ::dx_agent_api::attribution::Role::Channel(
                ::dx_agent_api::attribution::ChannelKind::Webhook,
            )
