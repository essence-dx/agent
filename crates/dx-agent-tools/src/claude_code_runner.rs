...
use dx_agent_config::schema::ClaudeCodeRunnerConfig;
...
/// execution events back to DX Agent's gateway endpoint, enabling live Slack
...
pub struct ClaudeCodeRunnerTool {
    ...
    /// Base URL of the DX Agent gateway (e.g. `"http://localhost:3000"`).
    gateway_url: String,
}
