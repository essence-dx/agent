    ...
    pub fn new(alias: &str, credential: Option<&str>, timeout_secs: Option<u64>) -> Self {
        Self {
            ...
            timeout_secs: timeout_secs
                .filter(|secs| *secs > 0)
                .unwrap_or(dx_agent_api::model_provider::BASELINE_TIMEOUT_SECS),
            max_tokens: None,
            extra_body: None,
        }
    }
...
impl ::dx_agent_api::attribution::Attributable for OpenRouterModelProvider {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Provider(
            ::dx_agent_api::attribution::ProviderKind::Model(
                ::dx_agent_api::attribution::ModelProviderKind::OpenRouter,
            ),
        )
    }
    fn alias(&self) -> &str {
...
mod tests {
    ...
    fn falls_back_to_default_timeout_for_zero() {
        ...
        assert_eq!(
            ...
            dx_agent_api::model_provider::BASELINE_TIMEOUT_SECS
        );
    }
