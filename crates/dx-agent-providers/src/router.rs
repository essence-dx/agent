        ...
        let resolved_routes: HashMap<String, (usize, String)> = routes
            ...
            .filter_map(|(hint, route)| {
                ...
                match index {
                    ...
                    None => {
                        ::dx_agent_log::record!(WARN, ::dx_agent_log::Event::new(module_path!(), ::dx_agent_log::Action::Note).with_outcome(::dx_agent_log::EventOutcome::Unknown).with_attrs(::serde_json::json!({"hint": hint, "model_provider": route.provider_name})), "Route references unknown model_provider, skipping");
                        None
                    }
                }
            })
...
impl ModelProvider for RouterModelProvider {
    async fn chat_with_system(
        ...
        ::dx_agent_log::record!(INFO, ::dx_agent_log::Event::new(module_path!(), ::dx_agent_log::Action::Note).with_attrs(::serde_json::json!({"model_provider": provider_name.as_str(), "model": resolved_model.as_str()})), "router dispatching request");
...
impl ::dx_agent_api::attribution::Attributable for RouterModelProvider {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Provider(
            ::dx_agent_api::attribution::ProviderKind::Model(
                ::dx_agent_api::attribution::ModelProviderKind::Router,
            ),
        )
    }
    fn alias(&self) -> &str {
...
mod tests {
    ...
    impl ::dx_agent_api::attribution::Attributable for StreamingMockModelProvider {
        fn role(&self) -> ::dx_agent_api::attribution::Role {
            ::dx_agent_api::attribution::Role::Provider(
                ::dx_agent_api::attribution::ProviderKind::Model(
                    ::dx_agent_api::attribution::ModelProviderKind::Custom,
    ...
    impl ::dx_agent_api::attribution::Attributable for ToolEventStreamingMockModelProvider {
        fn role(&self) -> ::dx_agent_api::attribution::Role {
            ::dx_agent_api::attribution::Role::Provider(
                ::dx_agent_api::attribution::ProviderKind::Model(
                    ::dx_agent_api::attribution::ModelProviderKind::Custom,
    ...
    impl ::dx_agent_api::attribution::Attributable for CapableMockModelProvider {
        fn role(&self) -> ::dx_agent_api::attribution::Role {
            ::dx_agent_api::attribution::Role::Provider(
                ::dx_agent_api::attribution::ProviderKind::Model(
                    ::dx_agent_api::attribution::ModelProviderKind::Custom,
