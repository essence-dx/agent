...
impl QdrantMemory {
    ...
    pub async fn new(
        ...
        if mem.embedder.dimensions() > 0 {
            ...
            dx_agent_config::schema::v2::migrate_qdrant_collection_to_v3(
                &mem.client,
                &mem.base_url,
                &mem.collection,
    ...
    pub fn new_lazy(
        ...
        let client = dx_agent_config::schema::build_runtime_proxy_client("memory.qdrant");
...
impl ::dx_agent_api::attribution::Attributable for QdrantMemory {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Memory(::dx_agent_api::attribution::MemoryKind::Qdrant)
    }
    fn alias(&self) -> &str {
        &self.alias
    }
