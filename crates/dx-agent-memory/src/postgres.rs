    ...
    fn initialize_client(
        ...
        let init_handle = std::thread::Builder::new()
            ...
            .spawn(move || -> Result<Client> {
                ...
                dx_agent_config::schema::v2::migrate_postgres_memory_to_v3(
                    &mut client,
                    &schema_ident,
                    &qualified_table,
                )?;
...
impl ::dx_agent_api::attribution::Attributable for PostgresMemory {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Memory(::dx_agent_api::attribution::MemoryKind::Postgres)
    }
    fn alias(&self) -> &str {
        &self.alias
    }
