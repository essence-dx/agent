...
const SNAPSHOT_HEADER: &str = "# 🧠 DX Agent Memory Snapshot\n\n\
    > Auto-generated by DX Agent. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 DX Agent Memory Snapshot
...
I am DX Agent, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 DX Agent Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
