...
use dx_agent_config::schema::SearchMode;
...
impl SqliteMemory {
    ...
    pub fn new_named(alias: &str, workspace_dir: &Path, db_name: &str) -> anyhow::Result<Self> {
        ...
        dx_agent_config::schema::v2::migrate_sqlite_memory_to_v3(&db_path, &conn)?;
        Ok(Self {
    ...
    fn init_schema(conn: &Connection) -> anyhow::Result<()> {
        ...
        execute_batch_retry(
            ...
            -- migration in `dx_agent_config::schema::v2::migrate_sqlite_memory_to_v3`
...
impl Memory for SqliteMemory {
    ...
    async fn ensure_agent_uuid(&self, alias: &str) -> anyhow::Result<String> {
        ...
        tokio::task::spawn_blocking(move || -> anyhow::Result<String> {
            let conn = conn.lock();
            dx_agent_config::schema::v2::sqlite_ensure_agent_uuid(&conn, &alias)
        })
        .await?
    }
}

impl ::dx_agent_api::attribution::Attributable for SqliteMemory {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Memory(::dx_agent_api::attribution::MemoryKind::Sqlite)
    }
    fn alias(&self) -> &str {
        &self.alias
    }
