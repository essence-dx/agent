...
// under `~/.dx-agent/workspace/skills/<slug>/`.

use anyhow::{Context, Result};
use std::path::PathBuf;
use dx_agent_config::schema::SkillCreationConfig;
use dx_agent_memory::embeddings::EmbeddingProvider;
use dx_agent_memory::vector::cosine_similarity;
...
pub fn extract_tool_calls_from_history(
    history: &[dx_agent_providers::ChatMessage],
) -> Vec<ToolCallRecord> {
...
mod tests {
    ...
    use dx_agent_memory::embeddings::{EmbeddingProvider, NoopEmbedding};
