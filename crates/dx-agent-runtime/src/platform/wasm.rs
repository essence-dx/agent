...
//! The default DX Agent binary excludes it to maintain the 4.6 MB size target.

use super::traits::RuntimeAdapter;
use dx_agent_config::schema::WasmRuntimeConfig;
...
impl RuntimeAdapter for WasmRuntime {
    ...
    fn storage_path(&self) -> PathBuf {
        self.workspace_dir
            .as_ref()
            .map_or_else(|| PathBuf::from(".dx-agent"), |w| w.join(".dx-agent"))
    }
...
mod tests {
    ...
    fn wasm_storage_path_with_workspace() {
        ...
        assert_eq!(rt.storage_path(), PathBuf::from("/home/user/project/.dx-agent"));
    }
