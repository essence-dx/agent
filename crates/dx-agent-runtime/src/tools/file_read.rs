...
impl Tool for FileReadTool {
    ...
    async fn execute(&self, args: serde_json::Value) -> anyhow::Result<ToolResult> {
        ...
        // (see dx-agent-runtime::tools::mod).  Successful reads consume one
...
mod tests {
    ...
    mod e2e_helpers {
        ...
        use dx_agent_config::schema::MemoryConfig;
        use dx_agent_memory::{self, Memory};
        use dx_agent_providers::{ChatMessage, ChatRequest, ChatResponse, ModelProvider};
    ...
    async fn e2e_agent_file_read_pdf_extraction() {
        ...
        use e2e_helpers::*;
        use dx_agent_providers::{ChatResponse, ModelProvider, ToolCall};
    ...
    async fn e2e_live_file_read_pdf() {
        ...
        use e2e_helpers::*;
        use dx_agent_providers::openai_codex::OpenAiCodexModelProvider;
        use dx_agent_providers::{ModelProvider, ModelProviderRuntimeOptions};
