...
// Tool types from dx-agent-tools (direct imports, no shims)
pub use dx_agent_tools::ask_user::AskUserTool;
pub use dx_agent_tools::ask_user::ChannelMapHandle;
pub use dx_agent_tools::backup_tool::BackupTool;
pub use dx_agent_tools::browser::{BrowserTool, ComputerUseConfig};
pub use dx_agent_tools::browser_delegate::BrowserDelegateTool;
pub use dx_agent_tools::browser_open::BrowserOpenTool;
pub use dx_agent_tools::calculator::CalculatorTool;
pub use dx_agent_tools::canvas::{ALLOWED_CONTENT_TYPES, MAX_CONTENT_SIZE};
pub use dx_agent_tools::canvas::{CanvasStore, CanvasTool};
pub use dx_agent_tools::claude_code::ClaudeCodeTool;
pub use dx_agent_tools::claude_code_runner::ClaudeCodeRunnerTool;
pub use dx_agent_tools::cli_discovery::{DiscoveredCli, discover_cli_tools};
pub use dx_agent_tools::cloud_ops::CloudOpsTool;
pub use dx_agent_tools::cloud_patterns::CloudPatternsTool;
pub use dx_agent_tools::codex_cli::CodexCliTool;
pub use dx_agent_tools::composio::ComposioTool;
pub use dx_agent_tools::content_search::ContentSearchTool;
pub use dx_agent_tools::data_management::DataManagementTool;
pub use dx_agent_tools::discord_search::DiscordSearchTool;
pub use dx_agent_tools::escalate::EscalateToHumanTool;
pub use dx_agent_tools::file_download::FileDownloadTool;
pub use dx_agent_tools::file_edit::FileEditTool;
pub use dx_agent_tools::file_upload::FileUploadTool;
pub use dx_agent_tools::file_upload_bundle::FileUploadBundleTool;
pub use dx_agent_tools::file_write::FileWriteTool;
pub use dx_agent_tools::gemini_cli::GeminiCliTool;
pub use dx_agent_tools::git_operations::GitOperationsTool;
pub use dx_agent_tools::glob_search::GlobSearchTool;
pub use dx_agent_tools::google_workspace::GoogleWorkspaceTool;
pub use dx_agent_tools::hardware_board_info::HardwareBoardInfoTool;
pub use dx_agent_tools::hardware_memory_map::HardwareMemoryMapTool;
pub use dx_agent_tools::hardware_memory_read::HardwareMemoryReadTool;
pub use dx_agent_tools::http_request::HttpRequestTool;
pub use dx_agent_tools::image_gen::ImageGenTool;
pub use dx_agent_tools::image_info::ImageInfoTool;
pub use dx_agent_tools::jira_tool::JiraTool;
pub use dx_agent_tools::knowledge_tool::KnowledgeTool;
pub use dx_agent_tools::linkedin::LinkedInTool;
pub use dx_agent_tools::llm_task::LlmTaskTool;
pub use dx_agent_tools::mcp_client::McpRegistry;
pub use dx_agent_tools::mcp_deferred::{
    ActivatedToolSet, DeferredMcpToolSet, build_deferred_tools_section,
    build_deferred_tools_section_filtered,
};
pub use dx_agent_tools::mcp_tool::McpToolWrapper;
pub use dx_agent_tools::memory_export::MemoryExportTool;
pub use dx_agent_tools::memory_forget::MemoryForgetTool;
pub use dx_agent_tools::memory_purge::MemoryPurgeTool;
pub use dx_agent_tools::memory_recall::MemoryRecallTool;
pub use dx_agent_tools::memory_store::MemoryStoreTool;
pub use dx_agent_tools::microsoft365::Microsoft365Tool;
pub use dx_agent_tools::model_routing_config::ModelRoutingConfigTool;
pub use dx_agent_tools::notion_tool::NotionTool;
pub use dx_agent_tools::opencode_cli::OpenCodeCliTool;
#[cfg(feature = "rag-pdf")]
pub use dx_agent_tools::pdf_read::PdfReadTool;
pub use dx_agent_tools::pipeline::PipelineTool;
pub use dx_agent_tools::poll::PollTool;
pub use dx_agent_tools::project_intel::ProjectIntelTool;
pub use dx_agent_tools::proxy_config::ProxyConfigTool;
pub use dx_agent_tools::pushover::PushoverTool;
pub use dx_agent_tools::reaction::ReactionTool;
pub use dx_agent_tools::report_template_tool::ReportTemplateTool;
pub use dx_agent_tools::screenshot::ScreenshotTool;
pub use dx_agent_tools::sessions::{
    SessionDeleteTool, SessionResetTool, SessionsCurrentTool, SessionsHistoryTool,
    SessionsListTool, SessionsSendTool,
};
pub use dx_agent_tools::text_browser::TextBrowserTool;
pub use dx_agent_tools::tool_search::ToolSearchTool;
pub use dx_agent_tools::weather_tool::WeatherTool;
pub use dx_agent_tools::web_fetch::WebFetchTool;
pub use dx_agent_tools::web_search_tool::WebSearchTool;
pub use dx_agent_tools::wrappers::{PathGuardedTool, RateLimitedTool};

// Traits from dx-agent-api
pub use dx_agent_api::schema::{CleaningStrategy, SchemaCleanr};
pub use dx_agent_api::tool::{Tool, ToolResult, ToolSpec};
...
use std::sync::Arc;
use dx_agent_config::schema::{AliasedAgentConfig, Config};
use dx_agent_memory::Memory;
...
pub type PerToolChannelHandle =
    Arc<RwLock<HashMap<String, Arc<dyn dx_agent_api::channel::Channel>>>>;
...
impl ::dx_agent_api::attribution::Attributable for ArcDelegatingTool {
...
pub fn all_tools(
    config: Arc<Config>,
    security: &Arc<SecurityPolicy>,
    risk_profile: &dx_agent_config::schema::RiskProfileConfig,
    agent_alias: &str,
    memory: Arc<dyn Memory>,
    composio_key: Option<&str>,
    composio_entity_id: Option<&str>,
    browser_config: &dx_agent_config::schema::BrowserConfig,
    http_config: &dx_agent_config::schema::HttpRequestConfig,
    web_fetch_config: &dx_agent_config::schema::WebFetchConfig,
    workspace_dir: &std::path::Path,
    agents: &HashMap<String, AliasedAgentConfig>,
    fallback_api_key: Option<&str>,
    root_config: &dx_agent_config::schema::Config,
...
pub fn all_tools_with_runtime(
    ...
    if root_config.channels.discord.values().any(|d| d.archive) {
        match dx_agent_memory::SqliteMemory::new_named("sqlite", workspace_dir, "discord") {
            Ok(discord_mem) => {
    ...
    if let Some((family, alias, entry)) = root_config.resolved_model_provider_for_agent(agent_alias)
    {
        ...
        let llm_task_runtime_options =
            dx_agent_providers::provider_runtime_options_for_alias(root_config, family, alias);
    ...
    if let Ok(backend) =
        dx_agent_infra::make_session_backend(workspace_dir, &config.channels.session_backend)
    {
        ...
        // dx_agent_tools::sessions but NOT registered by default. They are
    ...
    if root_config.microsoft365.enabled {
        ...
        if !tenant_id.is_empty() && !client_id.is_empty() {
            ...
            let resolved = dx_agent_tools::microsoft365::types::Microsoft365ResolvedConfig {
                tenant_id,
                client_id,
    ...
    if root_config.knowledge.enabled {
        ...
        match dx_agent_memory::knowledge_graph::KnowledgeGraph::new(
            &db_path,
    ...
    let provider_runtime_options =
        dx_agent_providers::provider_runtime_options_for_agent(root_config, agent_alias);
    ...
    let delegate_handle: Option<DelegateParentToolsHandle> = if agents.is_empty() {
        ...
        .with_providers_models({
            ...
            let mut m: std::collections::HashMap<
                String,
                std::collections::HashMap<String, dx_agent_config::schema::ModelProviderConfig>,
    ...
    #[cfg(feature = "plugins-wasm")]
    {
        ...
        if plugin_path.exists() && config.plugins.enabled {
            match dx_agent_plugins::host::PluginHost::new(
                ...
                Ok(host) => {
                    ...
                    for (manifest, wasm_path) in details {
                        tool_arcs.push(Arc::new(dx_agent_plugins::wasm_tool::WasmTool::from_wasm(
...
mod tests {
    ...
    use dx_agent_config::schema::{BrowserConfig, Config, MemoryConfig};
    ...
    fn all_tools_excludes_browser_when_disabled() {
        ...
        let mem: Arc<dyn Memory> =
            Arc::from(dx_agent_memory::create_memory(&mem_cfg, tmp.path(), None).unwrap());
        ...
        let http = dx_agent_config::schema::HttpRequestConfig::default();
        ...
        let tools = all_tools(
            ...
            &browser,
            &http,
            &dx_agent_config::schema::WebFetchConfig::default(),
            tmp.path(),
            &HashMap::new(),
            None,
            &cfg,
    ...
    fn all_tools_excludes_read_skill_in_full_mode() {
        ...
        let http = dx_agent_config::schema::HttpRequestConfig::default();
        let mut cfg = test_config(&tmp);
        cfg.skills.prompt_injection_mode = dx_agent_config::schema::SkillsPromptInjectionMode::Full;
