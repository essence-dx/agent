...
use dx_agent_api::tool::{Tool, ToolResult};
...
impl DelegateTool {
    pub fn new(
        ...
        Self::new_with_options(
            ...
            global_credential,
            security,
            dx_agent_providers::ModelProviderRuntimeOptions::default(),
        )
    }
    ...
    pub fn with_multimodal_config(
        mut self,
        config: dx_agent_config::schema::MultimodalConfig,
    ) -> Self {
...
impl DelegateTool {
    ...
    async fn execute_sync(
        ...
        let model_provider: Box<dyn ModelProvider> =
            match dx_agent_providers::create_model_provider_with_options(
                &provider_type,
                credential.as_deref(),
...
impl DelegateTool {
    ...
    async fn execute_background(
        ...
        dx_agent_spawn::spawn!(
            ...
            .instrument(::dx_agent_log::attribution_span!(
    ...
    async fn execute_parallel(
        ...
        for agent_name in &agent_names {
            ...
            handles.push(dx_agent_spawn::spawn!(
                async move {
                    let inner = DelegateTool {
                        agents,
                        security,
    ...
    fn build_enriched_system_prompt(
        ...
        let ctx = PromptContext {
            ...
            tools: prompt_tools,
            skills: &skills,
            skills_prompt_mode: dx_agent_config::schema::SkillsPromptInjectionMode::Full,
...
impl ::dx_agent_api::attribution::Attributable for ToolArcRef {
...
mod tests {
    ...
    use dx_agent_providers::{ChatRequest, ChatResponse, ToolCall};

    dx_agent_api::mock_tool_attribution!(EchoTool, FakeMcpTool);
    ...
    fn security_allowing() -> Arc<SecurityPolicy> {
        Arc::new(SecurityPolicy {
            delegation_policy: dx_agent_config::autonomy::DelegationPolicy {
                mode: dx_agent_config::autonomy::DelegationMode::Allow,
            },
    ...
    impl ::dx_agent_api::attribution::Attributable for OneToolThenFinalModelProvider {
        fn role(&self) -> ::dx_agent_api::attribution::Role {
    ...
    impl ::dx_agent_api::attribution::Attributable for TextFallbackToolModelProvider {
        fn role(&self) -> ::dx_agent_api::attribution::Role {
            ::dx_agent_api::attribution::Role::Provider(
                ::dx_agent_api::attribution::ProviderKind::Model(
                    ::dx_agent_api::attribution::ModelProviderKind::Custom,
    ...
    impl ::dx_agent_api::attribution::Attributable for InfiniteToolCallModelProvider {
        fn role(&self) -> ::dx_agent_api::attribution::Role {
            ::dx_agent_api::attribution::Role::Provider(
                ::dx_agent_api::attribution::ProviderKind::Model(
                    ::dx_agent_api::attribution::ModelProviderKind::Custom,
    ...
    impl ::dx_agent_api::attribution::Attributable for FailingModelProvider {
        fn role(&self) -> ::dx_agent_api::attribution::Role {
            ::dx_agent_api::attribution::Role::Provider(
                ::dx_agent_api::attribution::ProviderKind::Model(
                    ::dx_agent_api::attribution::ModelProviderKind::Custom,
    ...
    impl ::dx_agent_api::attribution::Attributable for McpToolThenFinalModelProvider {
        fn role(&self) -> ::dx_agent_api::attribution::Role {
            ::dx_agent_api::attribution::Role::Provider(
                ::dx_agent_api::attribution::ProviderKind::Model(
                    ::dx_agent_api::attribution::ModelProviderKind::Custom,
    ...
    fn enriched_prompt_includes_shell_policy_when_shell_present() {
        ...
        impl ::dx_agent_api::attribution::Attributable for MockShellTool {
            fn role(&self) -> ::dx_agent_api::attribution::Role {
                ::dx_agent_api::attribution::Role::Tool(
                    ::dx_agent_api::attribution::ToolKind::Shell,
                )
            }
            fn alias(&self) -> &str {
    ...
    ) -> Arc<dx_agent_config::schema::Config> {
        use dx_agent_config::autonomy::{DelegationMode, DelegationPolicy};
        use dx_agent_config::schema::{
    ...
    fn config_with_narrowed_target() -> Arc<dx_agent_config::schema::Config> {
        use dx_agent_config::autonomy::{DelegationMode, DelegationPolicy};
