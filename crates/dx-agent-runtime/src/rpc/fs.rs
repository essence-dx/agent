...
use dx_agent_api::jsonrpc::{FsEntry, FsListDirRequest, FsListDirResponse};

/// Handle `fs/list_dir`.
pub async fn handle_fs_list_dir(
    params: &serde_json::Value,
) -> Result<serde_json::Value, dx_agent_api::jsonrpc::JsonRpcError> {
...
fn rpc_err(code: i32, msg: impl Into<String>) -> dx_agent_api::jsonrpc::JsonRpcError {
    dx_agent_api::jsonrpc::JsonRpcError {
        code,
        message: msg.into(),
        data: None,
    }
