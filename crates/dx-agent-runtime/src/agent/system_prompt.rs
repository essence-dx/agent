...
pub fn build_system_prompt_with_mode(
    ...
    let autonomy_cfg = dx_agent_config::schema::RiskProfileConfig {
...
pub fn build_system_prompt_with_mode_and_autonomy(
    ...
    identity_config: Option<&dx_agent_config::schema::IdentityConfig>,
    bootstrap_max_chars: Option<usize>,
    autonomy_config: Option<&dx_agent_config::schema::RiskProfileConfig>,
    native_tools: bool,
    skills_prompt_mode: dx_agent_config::schema::SkillsPromptInjectionMode,
    ...
    if prompt.is_empty() {
        "You are DX Agent, a fast and efficient AI assistant built in Rust. Be helpful, concise, and direct."
            .to_string()
    } else {
        prompt
    }
