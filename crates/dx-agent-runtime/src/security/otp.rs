...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(dx_agent_dir);
...
pub fn secret_file_path(dx_agent_dir: &Path) -> PathBuf {
    dx_agent_dir.join(OTP_SECRET_FILE)
}
