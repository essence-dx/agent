...
//! [`dx_agent_config::schema::ChannelsConfig::channels`] instead.

use dx_agent_config::schema::ChannelsConfig;
use dx_agent_config::traits::ChannelInfo;
...
mod tests {
    ...
    fn channel_compile_specs_cover_schema_channel_types() {
        let out_of_scope = BTreeSet::from([
            ...
            // `dx-agent-channels` Channel implementation with its own feature.
            "voice_duplex",
        ]);

        for channel_type in dx_agent_config::schema::v2::V3_CHANNEL_TYPES {
