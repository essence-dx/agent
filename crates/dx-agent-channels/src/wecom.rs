...
impl WeComChannel {
    ...
    fn http_client(&self) -> reqwest::Client {
        dx_agent_config::schema::build_runtime_proxy_client("channel.wecom")
    }
    ...
    pub fn is_user_allowed(&self, user_id: &str) -> bool {
        ...
        ::dx_agent_log::record!(TRACE, ::dx_agent_log::Event::new(module_path!(), ::dx_agent_log::Action::Note).with_attrs(::serde_json::json!({"channel": "wecom", "alias": self.alias, "user_id": user_id, "allowed": allowed})), "wecom allowlist decision");
        allowed
    }
}

impl ::dx_agent_api::attribution::Attributable for WeComChannel {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Channel(::dx_agent_api::attribution::ChannelKind::WeCom)
    }
    fn alias(&self) -> &str {
        &self.alias
    }
