...
use dx_agent_config::schema::TranscriptionConfig;
...
#[async_trait]
pub trait TranscriptionProvider: Send + Sync + ::dx_agent_api::attribution::Attributable {
...
impl GroqProvider {
    ...
    /// schema-mirror env grammar `DX_AGENT_transcription__api_key=...`).
        ...
        let api_key = config
            ...
            .context(
                "Missing transcription API key: set `[transcription].api_key` (or via the \
                 schema-mirror grammar `DX_AGENT_transcription__api_key=...`).",
            )?;
...
impl TranscriptionProvider for GroqProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client = dx_agent_config::schema::build_runtime_proxy_client("transcription.groq");
...
impl OpenAiWhisperProvider {
    pub fn from_config(
        alias: &str,
        config: &dx_agent_config::schema::OpenAiSttConfig,
    ) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
...
impl TranscriptionProvider for OpenAiWhisperProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client = dx_agent_config::schema::build_runtime_proxy_client("transcription.openai");
...
impl DeepgramProvider {
    pub fn from_config(
        alias: &str,
        config: &dx_agent_config::schema::DeepgramSttConfig,
    ) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
...
impl TranscriptionProvider for DeepgramProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client = dx_agent_config::schema::build_runtime_proxy_client("transcription.deepgram");
...
impl AssemblyAiProvider {
    pub fn from_config(
        alias: &str,
        config: &dx_agent_config::schema::AssemblyAiSttConfig,
    ) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
...
impl TranscriptionProvider for AssemblyAiProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client =
            dx_agent_config::schema::build_runtime_proxy_client("transcription.assemblyai");
...
impl GoogleSttProvider {
    pub fn from_config(
        alias: &str,
        config: &dx_agent_config::schema::GoogleSttConfig,
    ) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
...
impl TranscriptionProvider for GoogleSttProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client = dx_agent_config::schema::build_runtime_proxy_client("transcription.google");
...
impl LocalWhisperProvider {
    ...
    pub fn from_config(
        alias: &str,
        config: &dx_agent_config::schema::LocalWhisperConfig,
    ) -> Result<Self> {
...
impl TranscriptionProvider for LocalWhisperProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client =
            dx_agent_config::schema::build_runtime_proxy_client("transcription.local_whisper");
...
impl TranscriptionManager {
    ...
    pub async fn transcribe_with_provider(
        ...
        let span = ::dx_agent_log::attribution_span!(p.as_ref());
...
impl ::dx_agent_api::attribution::Attributable for GroqProvider {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Provider(
            ::dx_agent_api::attribution::ProviderKind::Transcription(
                ::dx_agent_api::attribution::TranscriptionProviderKind::Groq,
            ),
        )
    }
    fn alias(&self) -> &str {
...
impl ::dx_agent_api::attribution::Attributable for OpenAiWhisperProvider {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Provider(
            ::dx_agent_api::attribution::ProviderKind::Transcription(
                ::dx_agent_api::attribution::TranscriptionProviderKind::OpenAi,
            ),
        )
    }
    fn alias(&self) -> &str {
...
impl ::dx_agent_api::attribution::Attributable for DeepgramProvider {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Provider(
            ::dx_agent_api::attribution::ProviderKind::Transcription(
                ::dx_agent_api::attribution::TranscriptionProviderKind::Deepgram,
            ),
        )
    }
    fn alias(&self) -> &str {
...
impl ::dx_agent_api::attribution::Attributable for AssemblyAiProvider {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Provider(
            ::dx_agent_api::attribution::ProviderKind::Transcription(
                ::dx_agent_api::attribution::TranscriptionProviderKind::AssemblyAi,
            ),
        )
    }
    fn alias(&self) -> &str {
...
impl ::dx_agent_api::attribution::Attributable for GoogleSttProvider {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Provider(
            ::dx_agent_api::attribution::ProviderKind::Transcription(
                ::dx_agent_api::attribution::TranscriptionProviderKind::Google,
            ),
        )
    }
    fn alias(&self) -> &str {
...
impl ::dx_agent_api::attribution::Attributable for LocalWhisperProvider {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Provider(
            ::dx_agent_api::attribution::ProviderKind::Transcription(
                ::dx_agent_api::attribution::TranscriptionProviderKind::Whisper,
            ),
        )
    }
    fn alias(&self) -> &str {
...
mod tests {
    ...
    fn manager_registers_multiple_providers() {
        ...
        let config = TranscriptionConfig {
            api_key: Some("test-groq-key".to_string()),
            openai: Some(dx_agent_config::schema::OpenAiSttConfig {
                api_key: Some("test-openai-key".to_string()),
                model: "whisper-1".to_string(),
            }),
            deepgram: Some(dx_agent_config::schema::DeepgramSttConfig {
    ...
    fn local_whisper_config(url: &str) -> dx_agent_config::schema::LocalWhisperConfig {
        dx_agent_config::schema::LocalWhisperConfig {
            url: url.to_string(),
