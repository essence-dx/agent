...
impl BlueskyChannel {
    ...
    fn http_client(&self) -> reqwest::Client {
        dx_agent_config::schema::build_runtime_proxy_client("channel.bluesky")
    }
...
impl ::dx_agent_api::attribution::Attributable for BlueskyChannel {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Channel(
            ::dx_agent_api::attribution::ChannelKind::Bluesky,
        )
    }
    fn alias(&self) -> &str {
        &self.alias
