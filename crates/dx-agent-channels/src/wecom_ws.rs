...
use dx_agent_config::schema::{StreamMode, WeComWsConfig};
...
impl WeComWsChannel {
    ...
    pub fn new_with_alias(
        ...
        let client = dx_agent_config::schema::build_channel_proxy_client_with_timeouts(
            "channel.wecom_ws",
...
impl ::dx_agent_api::attribution::Attributable for WeComWsChannel {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Channel(
            ::dx_agent_api::attribution::ChannelKind::WeComWs,
        )
    }
...
impl Channel for WeComWsChannel {
    ...
    async fn listen(&self, tx: tokio::sync::mpsc::Sender<ChannelMessage>) -> Result<()> {
        ...
        loop {
            ...
            let ws_stream = match dx_agent_config::schema::ws_connect_with_proxy(
                WECOM_WS_URL,
                "channel.wecom_ws",
...
mod tests {
    ...
    async fn send_with_req_id_uses_respond_msg_when_stream_mode_off() {
        ...
        *channel.ws_tx.lock().await = Some(ws_tx);
        ...
        let responder = dx_agent_spawn::spawn!(async move {
    ...
    async fn stream_reply_serializes_same_req_id_updates() {
        ...
        *channel.ws_tx.lock().await = Some(tx);
        ...
        let first = dx_agent_spawn::spawn!(async move {
            first_channel
        ...
        let second = dx_agent_spawn::spawn!(async move {
            second_channel
