...
use dx_agent_config::schema::{Config, TtsProviderConfig};
...
pub trait TtsProvider: Send + Sync + ::dx_agent_api::attribution::Attributable {
        ...
        let api_key = config
            ...
            .context(
                "Missing OpenAI TTS API key: set `[tts_providers.openai.<alias>].api_key` (or via \
                 `DX_AGENT_providers__tts__openai__<alias>__api_key=...`).",
            )?;
        ...
        let api_key = config
            ...
            .context(
                "Missing ElevenLabs API key: set `[tts_providers.elevenlabs.<alias>].api_key` (or \
                 via `DX_AGENT_providers__tts__elevenlabs__<alias>__api_key=...`).",
            )?;
        ...
        let api_key = config
            ...
            .context(
                "Missing Google TTS API key: set `[tts_providers.google.<alias>].api_key` (or via \
                 `DX_AGENT_providers__tts__google__<alias>__api_key=...`).",
            )?;
...
impl TtsManager {
    ...
    pub async fn synthesize_with_provider(
        ...
        let span = ::dx_agent_log::attribution_span!(tts.as_ref());
        ::dx_agent_log::scope!(voice: voice, => tts.synthesize(text, voice))
            .instrument(span)
            .await
    }
...
impl ::dx_agent_api::attribution::Attributable for OpenAiTtsProvider {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Provider(::dx_agent_api::attribution::ProviderKind::Tts(
            ::dx_agent_api::attribution::TtsProviderKind::OpenAi,
        ))
    }
    fn alias(&self) -> &str {
        &self.alias
...
impl ::dx_agent_api::attribution::Attributable for ElevenLabsTtsProvider {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Provider(::dx_agent_api::attribution::ProviderKind::Tts(
            ::dx_agent_api::attribution::TtsProviderKind::ElevenLabs,
        ))
    }
    fn alias(&self) -> &str {
        &self.alias
...
impl ::dx_agent_api::attribution::Attributable for GoogleTtsProvider {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Provider(::dx_agent_api::attribution::ProviderKind::Tts(
            ::dx_agent_api::attribution::TtsProviderKind::Google,
        ))
    }
    fn alias(&self) -> &str {
        &self.alias
...
impl ::dx_agent_api::attribution::Attributable for EdgeTtsProvider {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Provider(::dx_agent_api::attribution::ProviderKind::Tts(
            ::dx_agent_api::attribution::TtsProviderKind::Edge,
        ))
    }
    fn alias(&self) -> &str {
        &self.alias
...
impl ::dx_agent_api::attribution::Attributable for PiperTtsProvider {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Provider(::dx_agent_api::attribution::ProviderKind::Tts(
            ::dx_agent_api::attribution::TtsProviderKind::Piper,
        ))
    }
    fn alias(&self) -> &str {
        &self.alias
...
mod tests {
    ...
    fn config_with_edge_alias() -> Config {
        ...
        cfg.providers.tts.edge.insert(
            "default".to_string(),
            dx_agent_config::schema::EdgeTtsProviderConfig {
    ...
    fn config_with_piper_alias() -> Config {
        ...
        cfg.providers.tts.piper.insert(
            "default".to_string(),
            dx_agent_config::schema::PiperTtsProviderConfig {
                base: TtsProviderConfig {
    ...
    fn tts_config_defaults() {
        let config = dx_agent_config::schema::TtsConfig::default();
