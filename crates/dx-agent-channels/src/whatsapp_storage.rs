//! Custom wa-rs storage backend using DX Agent's rusqlite
//!
...
/// The backend uses DX Agent's existing rusqlite setup, avoiding the
...
impl ProtocolStore for RusqliteStore {
    ...
    // cleanup hook DX Agent doesn't yet schedule — see TODO in
