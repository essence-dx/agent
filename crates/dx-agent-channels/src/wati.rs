...
impl WatiChannel {
    ...
    pub fn new_with_proxy(
        ...
        Self {
            ...
            alias: alias.into(),
            peer_resolver,
            client: dx_agent_config::schema::build_channel_proxy_client(
                "channel.wati",
                proxy_url.as_deref(),
            ),
...
impl ::dx_agent_api::attribution::Attributable for WatiChannel {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Channel(::dx_agent_api::attribution::ChannelKind::Wati)
    }
    fn alias(&self) -> &str {
        &self.alias
    }
