...
pub use dx_agent_config::scattered_types::ClawdTalkConfig;
...
impl ::dx_agent_api::attribution::Attributable for ClawdTalkChannel {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Channel(
            ::dx_agent_api::attribution::ChannelKind::ClawdTalk,
        )
    }
    fn alias(&self) -> &str {
        &self.alias
