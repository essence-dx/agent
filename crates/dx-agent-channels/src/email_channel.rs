...
pub use dx_agent_config::scattered_types::EmailConfig;
...
impl EmailChannel {
    ...
    fn extract_attachments(
    ...
    ) -> Vec<dx_agent_api::media::MediaAttachment> {
        ...
        for part in parsed.attachments() {
            ...
            attachments.push(dx_agent_api::media::MediaAttachment {
                file_name,
                data,
                mime_type: mime_str,
            });
...
struct ParsedEmail {
    ...
    content: String,
    timestamp: u64,
    attachments: Vec<dx_agent_api::media::MediaAttachment>,
}
...
impl ::dx_agent_api::attribution::Attributable for EmailChannel {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Channel(::dx_agent_api::attribution::ChannelKind::Email)
    }
    fn alias(&self) -> &str {
        &self.alias
    }
...
/// [`MediaAttachment`](dx_agent_api::media::MediaAttachment) values whose
/// bytes were intentionally omitted (e.g. created via
/// [`MediaAttachment::from_file`](dx_agent_api::media::MediaAttachment::from_file)
