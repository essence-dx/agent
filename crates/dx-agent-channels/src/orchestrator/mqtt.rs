...
use dx_agent_config::schema::MqttConfig;
use dx_agent_runtime::sop::audit::SopAuditLogger;
use dx_agent_runtime::sop::dispatch::{dispatch_sop_event, process_headless_results};
use dx_agent_runtime::sop::engine::{SopEngine, now_iso8601};
use dx_agent_runtime::sop::types::{SopEvent, SopTriggerSource};
...
pub async fn run_mqtt_sop_listener(
    ...
    dx_agent_runtime::health::mark_component_ok("mqtt");
    ...
    loop {
        match eventloop.poll().await {
            ...
            Err(e) => {
                dx_agent_runtime::health::mark_component_error("mqtt", e.to_string());
                ::dx_agent_log::record!(
                    WARN,
                    ::dx_agent_log::Event::new(module_path!(), ::dx_agent_log::Action::Note)
