...
impl NextcloudTalkChannel {
    ...
    ///
    /// Prevents feedback loops where DX Agent reacts to its own messages.
...
impl ::dx_agent_api::attribution::Attributable for NextcloudTalkChannel {
    fn role(&self) -> ::dx_agent_api::attribution::Role {
        ::dx_agent_api::attribution::Role::Channel(
            ::dx_agent_api::attribution::ChannelKind::NextcloudTalk,
        )
    }
    fn alias(&self) -> &str {
        &self.alias
