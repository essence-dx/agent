//! Plugin manifest — `~/.dx-agent/tools/<name>/tool.toml` schema.
//!
...
/// Execution configuration — how DX Agent spawns the tool.
#[derive(Debug, Deserialize)]
...
///
/// When present, DX Agent will prefer the named transport kind
