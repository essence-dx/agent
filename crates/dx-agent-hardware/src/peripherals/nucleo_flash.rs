//! Flash DX Agent Nucleo-F401RE firmware via probe-rs.
//!
...
/// Flash DX Agent Nucleo firmware. Builds from firmware/nucleo.
pub fn flash_nucleo_firmware() -> Result<()> {
    ...
    println!("Building DX Agent Nucleo firmware...");
    ...
    println!("DX Agent Nucleo firmware flashed successfully.");
