//! Flash DX Agent Arduino firmware via arduino-cli.
//!
...
/// DX Agent Arduino Uno base firmware (capabilities, gpio_read, gpio_write).
...
/// Flash DX Agent firmware to Arduino at the given port.
pub fn flash_arduino_firmware(port: &str) -> Result<()> {
    ...
    // Compile
    println!("Compiling DX Agent Arduino firmware...");
    ...
    println!("DX Agent firmware flashed successfully.");
