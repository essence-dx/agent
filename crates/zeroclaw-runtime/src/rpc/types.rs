...
rpc_type! {
    ...
    pub struct CatalogModelProvider {
        ...
        pub local: bool,
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub source: Option<zeroclaw_providers::provider_catalog::ModelProviderCatalogSource>,
        #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl From<zeroclaw_providers::ModelProviderInfo> for CatalogModelProvider {
    fn from(provider: zeroclaw_providers::ModelProviderInfo) -> Self {
        ...
        Self {
            ...
            source: Some(zeroclaw_providers::provider_catalog::ModelProviderCatalogSource::Native),
            model_count: None,
            identity,
            freemium,
        }
...
impl From<zeroclaw_providers::provider_catalog::ModelProviderCatalogEntry>
    for CatalogModelProvider
{
    fn from(provider: zeroclaw_providers::provider_catalog::ModelProviderCatalogEntry) -> Self {
        let identity = provider.identity();
        let freemium = provider.freemium();
...
impl From<zeroclaw_providers::provider_catalog::DxProvidersCatalogLoadDiagnostic>
    for ProviderCatalogDiagnostic
{
    fn from(
        diagnostic: zeroclaw_providers::provider_catalog::DxProvidersCatalogLoadDiagnostic,
    ) -> Self {
        Self {
...
impl From<zeroclaw_providers::provider_catalog::ModelProviderCatalogListing> for CatalogResponse {
    fn from(listing: zeroclaw_providers::provider_catalog::ModelProviderCatalogListing) -> Self {
        Self {
...
mod catalog_model_provider_tests {
    ...
    fn catalog_provider_row_preserves_opencode_freemium_metadata() {
        let provider = zeroclaw_providers::list_model_providers()
            .into_iter()
    ...
    fn catalog_provider_row_marks_dx_catalog_source_and_model_count() {
        let row = CatalogModelProvider::from(
            zeroclaw_providers::provider_catalog::ModelProviderCatalogEntry {
                name: "example-labs".to_string(),
                display_name: "Example Labs".to_string(),
                local: false,
                source: zeroclaw_providers::provider_catalog::ModelProviderCatalogSource::DxProvidersCatalog,
                model_count: 42,
            },
        );
        ...
        assert_eq!(
            row.source,
            Some(zeroclaw_providers::provider_catalog::ModelProviderCatalogSource::DxProvidersCatalog)
        );
    ...
    fn catalog_response_preserves_dx_provider_catalog_diagnostic() {
        let listing = zeroclaw_providers::provider_catalog::ModelProviderCatalogListing {
            entries: vec![zeroclaw_providers::provider_catalog::ModelProviderCatalogEntry {
                name: "example-labs".to_string(),
                display_name: "Example Labs".to_string(),
                local: false,
                source: zeroclaw_providers::provider_catalog::ModelProviderCatalogSource::DxProvidersCatalog,
            ...
            dx_providers_catalog: Some(
                zeroclaw_providers::provider_catalog::DxProvidersCatalogLoadDiagnostic {
