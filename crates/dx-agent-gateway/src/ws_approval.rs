...
//! [`Channel::request_approval`](dx_agent_api::channel::Channel::request_approval)
...
use uuid::Uuid;
use dx_agent_api::agent::TurnEvent;
...
impl ::dx_agent_api::attribution::Attributable for WsApprovalChannel {
