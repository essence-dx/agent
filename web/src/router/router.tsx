...
function AgentChatRoute() {
  ...
  const agentAlias = alias?.trim();
  if (!agentAlias) return <Navigate to="/agents" replace />;

  return (
    <AgentProvider key={agentAlias} agentAlias={agentAlias}>
      <AgentChat />
    </AgentProvider>
  );
}
  ...
  <Suspense fallback={<RouteFallback />}>
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="/agent/:alias" element={<AgentChatRoute />} />
