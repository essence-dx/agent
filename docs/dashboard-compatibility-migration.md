...
- `DX_AGENTS_GATEWAY_PORT` prefers DX naming while `DX_AGENT_GATEWAY_PORT` remains readable.
...
- `DX_AGENT_CONFIG_DIR` -> `DX_AGENTS_CONFIG_DIR`
- `DX_AGENT_WORKSPACE` -> `DX_AGENTS_WORKSPACE`
- `DX_AGENT_PROVIDER` -> `DX_AGENTS_PROVIDER`
- `DX_AGENT_MODEL` -> `DX_AGENTS_MODEL`
- `DX_AGENT_PROVIDER_URL` -> `DX_AGENTS_PROVIDER_URL`
- `DX_AGENT_API_KEY` -> `DX_AGENTS_API_KEY`
- `DX_AGENT_CODEX_BASE_URL` -> `DX_AGENTS_CODEX_BASE_URL`
- `DX_AGENT_CODEX_RESPONSES_URL` -> `DX_AGENTS_CODEX_RESPONSES_URL`
- `DX_AGENT_CODEX_REASONING_EFFORT` -> `DX_AGENTS_CODEX_REASONING_EFFORT`
- `DX_AGENT_ACP_TOKEN` -> `DX_AGENTS_ACP_TOKEN`
- `DX_AGENT_ACP_GATEWAY_URL` -> `DX_AGENTS_ACP_GATEWAY_URL`
- `DX_AGENT_GATEWAY_PORT` -> `DX_AGENTS_GATEWAY_PORT`
- `DX_AGENT_GATEWAY_TOKEN` -> `DX_AGENTS_GATEWAY_TOKEN`
- `DX_AGENT_ACP_BRIDGE_TOKEN` -> `DX_AGENTS_ACP_BRIDGE_TOKEN`
- `DX_AGENT_ACP_PAIRING_CODE` -> `DX_AGENTS_ACP_PAIRING_CODE`
- `__DX_AGENT_BASE__` -> `__DX_AGENTS_BASE__`
- `__DX_AGENT_GATEWAY__` -> `__DX_AGENTS_GATEWAY__`
