...
| New channel | [Architecture overview](../architecture/overview.md), [Crates](../architecture/crates.md), [Channels overview](../channels/overview.md), existing implementations in `crates/dx-agent-channels/` | Channels are user-visible boundaries; validate both inbound and outbound behavior. |
